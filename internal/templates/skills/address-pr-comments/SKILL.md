...
- Delegate to `/audit-and-fix-uncommitted` when the implemented changes are substantive, touch more than 500 lines of code, or touch more than 10 files excluding docs.
- Do not call `/audit-and-fix-uncommitted` for non-substantive changes such as docs-only updates, typo fixes, obvious bug fixes, metadata-only edits, or reply-only outcomes.
...
2. For substantive changes, use the `/audit-and-fix-uncommitted` skill to review and stabilize them.
3. For non-substantive changes, do not call `/audit-and-fix-uncommitted`; record the judgement in your working notes and run targeted verification appropriate to the change.
...
- Do not call `/audit-and-fix-uncommitted` reflexively for non-substantive changes.
- Do not skip `/audit-and-fix-uncommitted` when the changes are substantive.
...
- Substantive changes were reviewed with `/audit-and-fix-uncommitted`; for non-substantive changes, the final handoff states why it was not called and what verification ran.
