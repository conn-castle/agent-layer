...
//
//go:embed config.toml mcp-catalog.toml commands.allow env gitignore.block agent-layer.gitignore instructions/*.md skills/* docs/agent-layer/*.md launchers manifests/*.json migrations/*.json
var FS embed.FS
