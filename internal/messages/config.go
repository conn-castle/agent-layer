...
const (
	...
	ConfigDispatchNamePoolExhaustedFmt            = "could not allocate a unique dispatch name: %d retained conversations and %d active executions occupy the %d-name pool; shorten dispatch.session_retention_days (currently %d days) to free retained names"
	ConfigDispatchNamePoolExhaustedUnreadableFmt  = "could not allocate a unique dispatch name: %d retained conversations, %d active executions, and %d unreadable occupants occupy the %d-name pool; shorten dispatch.session_retention_days (currently %d days) to free retained names"
