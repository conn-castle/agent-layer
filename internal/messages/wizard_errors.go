...
const (
	...
	WizardCodexAppsInlineFeaturesUnsupported = "agents.codex.agent_specific.features uses inline table syntax; expand it to [agents.codex.agent_specific.features] before changing Codex apps with al wizard"
