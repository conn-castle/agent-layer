...
const (
	...
	InstallGitignoreUnsupportedInlineCommentFmt      = "managed gitignore block has an unsupported inline comment after %s; Git does not treat # as a comment after a pattern. Use %s to ignore, or # %s to track"
