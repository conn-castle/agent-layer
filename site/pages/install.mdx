...
If a repo is pinned, run `al upgrade plan` and then `al upgrade` inside the repo. This updates the repo pin (`.agent-layer/al.version`) and refreshes template-managed files.
