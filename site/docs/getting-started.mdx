...
Any client command (antigravity/claude/codex/copilot/vscode) will:
...
| `al probe antigravity` | Report observed Antigravity capabilities. | [CLI guide](./reference#cli-guide) |
