...
.agent-layer/
  ...
  skills/             # <name>.md or <name>/SKILL.md
...
Skill sources follow the [agentskills.io specification](https://agentskills.io/specification). Agent Layer supports both flat and directory formats; for directory skills, canonical `SKILL.md` is preferred and lowercase `skill.md` remains a compatibility fallback that triggers an `al doctor` warning.
