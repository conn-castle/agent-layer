...
Skill sources follow the [agentskills.io specification](https://agentskills.io/specification). All skills use directory format (`.agent-layer/skills/<name>/SKILL.md`) and require the uppercase canonical filename; lowercase `skill.md` is rejected.
