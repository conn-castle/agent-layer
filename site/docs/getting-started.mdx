...
Skill sources follow the [agentskills.io specification](https://agentskills.io/specification). User-managed skills use `.agent-layer/skills/<name>/SKILL.md`; imported skills use `.agent-layer/imported-skills/<name>/SKILL.md`. Both tiers require the uppercase canonical filename; lowercase `skill.md` is rejected.
