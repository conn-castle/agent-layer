...
The same repo then behaves the same whether you launch Antigravity, Claude, Codex, Copilot CLI, Grok, or VS Code. You do not copy configuration between clients. You review and refine agent setup in one folder.
