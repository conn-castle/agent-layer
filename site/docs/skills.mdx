...
| `verify-work` | Post-implementation completeness check. Compares what was actually built against the plan or request, reporting gaps, regressions, missing tests or docs, working-code evidence, and scope drift. |
