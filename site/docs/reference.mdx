...
| --- | --- | --- |
| `repository` | yes | Source Git repository, reached through your existing Git authentication. Supported transports are HTTPS, SSH, Git, file, scp-style SSH, and local paths. |
