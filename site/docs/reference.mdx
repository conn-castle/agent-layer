...
`.agent-layer/skills/` supports two source formats:

- Flat: `.agent-layer/skills/<name>.md`
- Directory: `.agent-layer/skills/<name>/SKILL.md` (canonical; lowercase `skill.md` is accepted as a compatibility fallback)
