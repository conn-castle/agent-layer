...
ENVEOF
  ...
  assert_json_valid "$repo_dir/.muse-config/muse/settings.json" "Muse settings generated by all-enabled wizard"
  assert_file_contains "$repo_dir/.muse-config/muse/settings.json" '"muse-github"' \
